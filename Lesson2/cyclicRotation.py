...
def solution(A, K):
    ...
    # If K is greater than N, take the remainder to avoid unnecessary rotations
    K = K % N
...
# Example usage:
result1 = solution([3, 8, 9, 7, 6], 3)
result2 = solution([0, 0, 0], 1)
result3 = solution([1, 2, 3, 4], 4)

print(result1)  # Output: [9, 7, 6, 3, 8]
