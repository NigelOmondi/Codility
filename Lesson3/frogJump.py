...
# position greater than or equal to Y. The small frog always jumps a f
# ixed distance, D.
...
def solution(X, Y, D):
    ...
    # Calculate the number of jumps needed (rounding up to the nearest integer)
    minimal_jumps = -(-distance_to_cover // D)
